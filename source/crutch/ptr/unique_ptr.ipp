...
UniquePtr<Type, Deleter>::UniquePtr(Type* pointer) requires DefaultConstructible<Deleter>
...
UniquePtr<Type, Deleter>::UniquePtr(
    UniquePtr<OtherType, OtherDeleter>&& other) noexcept requires Constructible<Deleter, OtherDeleter&&>
